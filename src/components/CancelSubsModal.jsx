...
import CancelSubscriptionButton from './CancelSubsButton';
const style = {
  position: 'absolute',
  top: '50%',
  left: '50%',
...
const {stripeCustomerId}=useSelector((state)=>state.auth)
    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          Are you certain you wish to cancel your subscription?
